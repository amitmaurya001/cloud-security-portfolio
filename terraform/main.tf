...
resource "aws_s3_bucket" "site" {
  bucket = var.domain_name != "" ? var.domain_name : lower(replace(var.project_name, " ", "-"))
}
...
# Grant CloudFront OAC read access via bucket policy
resource "aws_s3_bucket_policy" "site" {
  ...
  # Policy references the distribution ARN, so wait for it to exist
...
# ---------------------------------------------------------------------------
# Route 53 — Alias Records (root + www)
# ---------------------------------------------------------------------------
