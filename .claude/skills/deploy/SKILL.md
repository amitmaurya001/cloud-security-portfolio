...
- [ ] Sync site files from project root (excluding terraform and config files): `aws s3 sync . s3://<bucket> --exclude "terraform/*" --exclude ".git/*" --exclude ".github/*" --exclude "*.md" --exclude ".claude/*" --exclude ".cursor/*" --exclude ".mcp.json" --delete`
